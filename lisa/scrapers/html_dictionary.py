...
ISM_MAN_REPORT_STRUCTURE = MappingProxyType(
    {
        "headline": (bs4_args(method="find", name="h1"),),
        "title": (bs4_args(method="find", name="h1"), bs4_args(method="find_next_sibling", name="h1")),
        "highlights": (bs4_args(method="find", name="h3", class_="text-center"),),
        "overview": (
